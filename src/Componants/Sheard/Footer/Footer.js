...
const Footer = () => {
  return (
    <footer className='footerFixed bg-slate-800  w-full py-8 mt-8'>
      <div className='max-w-screen-xl mx-auto px-4'>
        <div className=' flex max-w-xs mx-auto items-center justify-between'>
          ...
          >
            <svg
              ...
              height='20'
              fill='currentColor'
              className='text-xl hover:text-violet-700 transition-colors duration-200'
              viewBox='0 0 1792 1792'
            >
          ...
          >
            <svg
              ...
              height='20'
              fill='currentColor'
              className='text-xl hover:text-blue-800 transition-colors duration-200'
              viewBox='0 0 1792 1792'
              xmlns='http://www.w3.org/2000/svg'
            >
        ...
        <div className='text-center text-white pt-10 sm:pt-12 font-light flex items-center justify-center'>
          All Rights Reserved By &copy; Sohag's IT Care | {(new Date().getFullYear())}
        </div>
      </div>
    </footer>
  )
